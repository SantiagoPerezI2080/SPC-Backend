...
SECRET_KEY = os.environ.get('SECRET_KEY', default='asbdahjsbdfajshdbasjdhasbjdah3434asdfaajshd')
...
# Cors authorization
CORS_ALLOWED_ORIGINS = ["http://localhost:5173","https://proyeccion.educarenemociones.com"]
